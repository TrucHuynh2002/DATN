  ...
  return (
    <div className="content">
        <div className="add-post">
            <h1 style={{ textAlign: "center", padding: "5px", color: "#0d3380" }}>Cập nhật bài đăng</h1>
            <Row>
                <Col sm={6}>
                    <Form.Group className="mb-3" controlId="post_name">
                        <Form.Label>Tên bài viết</Form.Label>
                        <Form.Control type="text" name="post_name" className='' value="" />
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="description_sort">
                        <Form.Label>Mô tả ngắn</Form.Label>
                        <Form.Control type="text" name="description_sort" className='' value="" />
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="description">
                        <Form.Label>Mô tả</Form.Label>
                        <Form.Control as="textarea" name="description" className='ckeditor' rows={3} value="" />
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="meta_keyword">
                        <Form.Label>Từ khóa</Form.Label>
                        <Form.Control type="text" name="meta_keyword" className='' value="" />
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="area">
                        <Form.Label>Diện tích</Form.Label>
                        <Form.Control type="text" name="area" className="" value="" />
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="room_price">
                        <Form.Label>Giá phòng</Form.Label>
                        <Form.Control type="text" name="room_price" className="" value="" />
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="water_pirce">
                        <Form.Label>Giá nước</Form.Label>
                        <Form.Control type="text" name="water_pirce" className="" value="" />
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="electricity_price">
                        <Form.Label>Giá điện</Form.Label>
                        <Form.Control type="text" name="electricity_price" className="" value="" />
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="address">
                        <Form.Label>Địa chỉ</Form.Label>
                        <Form.Control type="text" name="address" className="" value="" />
                    </Form.Group>
                </Col>
                <Col sm={6}>
                    <Form.Group className="mb-3" controlId="quantity">
                        <Form.Label>Số lượng</Form.Label>
                        <Form.Control type="text" name="quantity" className="" value="" />
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="created_at">
                        <Form.Label>Ngày đăng</Form.Label>
                        <Form.Control type="date" name="created_at" className="" value="" />
                    </Form.Group>
                    ...
                    <Form.Group className="mb-3" controlId="meta_title">
                        ...
                        <Form.Control type="text" name="meta_title" className="" value="" />
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="meta_description">
                        <Form.Label>Mô tả tiêu đề</Form.Label>
                        <Form.Control as="textarea" name="meta_description" className="" rows={3} value="" />
                    </Form.Group>
                    <Form.Group className="mb-3">
