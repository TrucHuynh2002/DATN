...
@section('main_acount')
    ...
    <div class="logo-header" data-background-color="blue">
        <a href="/" class="logo">
            <img style="width: 100%; height:200px; margin-top: -550px; margin-left: -60px;" src="/img/logo.PNG" alt="logo"
                class="logo">
        </a>
    </div>
    <form style="margin-left: -450px;" method="POST" action="{{ route('password.update') }}">
        ...
        <input id="email" class="form-control" placeholder="Email" type="hidden" name="email"
        ...
        <button style="width:100%;" type="submit" value="submit"
            class="btn btn-primary">{{ __('Đặt lại mật khẩu') }}</button>
    </form>
