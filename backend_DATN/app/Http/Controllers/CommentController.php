...
class CommentController extends Controller
{
    ...
    public function Comment_SelectPost(Request $request, $id_post)
    {
        $Comment_SelectPost = DB::table('comment')
            ->join('users', 'comment.id_user', '=', 'users.id_user')
            ->join('img_user','users.id_user','=','img_user.id_user')
            ->select('users.full_name','comment.content','comment.id_comment','img_user.link_img_user','comment.id_user','comment.created_at')
        ...
        ->join('users', 'comment.id_user', '=', 'users.id_user')
        ->join('img_user','users.id_user','=','img_user.id_user')
        ->select('users.full_name','comment.content','comment.id_comment','img_user.link_img_user','users.id_user','comment.param_id','comment.created_at')
        ->where('comment.id_post', $id_post)
